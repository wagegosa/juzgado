      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Listado de Historial</li>
          </ol>
          <div class="pull-right">
            <form action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
              <a href="index.php" class="btn btn-sm btn-success"><span class="glyphicon glyphicon-plus"></span> Nuevo Historial </a>
            </form>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        ...
        <form id="Con_Area" name="Con_Area" method="post">
           ...
           <table class="table table-bordered  table-hover table-striped" id="myTable" width="100%" name="myTable">
            <thead>
              <tr>
                <th data-filterable="false">Naturaleza</th>
                <th data-breakpoints="xs sm">Consecutivo</th>
                <th data-breakpoints="xs sm">Demandante</th>
                <th data-breakpoints="xs sm">Demandado</th>
                <th data-breakpoints="xs sm">Ingreso</th>
                <th data-breakpoints="xs sm">Terminación</th>
                <th data-breakpoints="xs sm">Novedad</th>
                <th data-breakpoints="xs sm">Archivo</th>
