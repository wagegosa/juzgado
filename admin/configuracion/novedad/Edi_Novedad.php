...
if (!empty($_SESSION['active']) && $_SESSION['perfil'] === "1") {
  if ($_GET != null) {
    ...
    $_GET['id'] ? $_GET['id'] : '';
    try {
      $query = "SELECT * FROM novedad WHERE id_novedad = " . $_GET['id'] . ";";
...
<body>
  <div class="container">
    ...
    <form action="../../../config/ClassNovedad/ClassNovedad_upd.php" class="frm" id="frm" autocomplete="off" method="post">
      ...
      <div class="row form-group">
        <input type="hidden" name="id" id="id" value="<?= $R['id_novedad'] ?>">
