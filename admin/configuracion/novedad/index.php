...
<body>
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-12">
        <h3 class="page-header"><span class="glyphicons glyphicons-group"></span> Novedad</h3>
        <ol class="breadcrumb">
        ...
        <div class="pull-right">
            <form action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
              <a href="New_Novedad.php" class="btn btn-sm btn-success"><span class="glyphicon glyphicon-plus"></span> Nueva Novedad </a>
            </form>
          </div>
      </div>
    </div>
           ...
           <table class="table table-bordered  table-hover table-striped" id="myTable" width="100%" name="myTable">
            ...
            <tbody>
              ...
              <tr>
                ...
                ; ?></td>
                <td>
                  <a href="Edi_Novedad.php?id=<?= $libro->id_novedad;?>" class="btn btn-primary btn-primary"><span class="glyphicon glyphicon-pencil"></span></a>
                </td>
              </tr>
              <?php endforeach ?>
            </tbody>
