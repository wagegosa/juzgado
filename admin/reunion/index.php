      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Consultar Reuniónes</li>
          </ol>
          <div class="pull-right">
            <form action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
              <a href="New_Reunion.php" class="btn btn-sm btn-success"><span class="glyphicon glyphicon-plus"></span> Nueva Reunión </a>
            </form>
          </div>
        </div>
      </div>
           ...
           <table class="table table-bordered  table-hover table-striped" id="myTable" width="100%" name="myTable">
            <thead>
              <tr>
                ...
                <th data-breakpoints="xs sm">Organizador</th>
                <th data-breakpoints="xs sm">Dirección</th>
                <th data-breakpoints="xs sm">Barrio</th>
                <th data-breakpoints="xs sm">Localidad</th>
            ...
            <tbody>
              ...
              <tr>
              <td><?= $c++; ?></td>
              <td><?= $libro->fec_reunio_inicio; ?></td>
              <td><?= $libro->organizador; ?></td>
              ...
              <td>
                <a href="Edi_Reunion.php?id=<?= $libro->idtba_reunion;?>" class="btn btn-primary btn-primary"><span class="glyphicon glyphicon-pencil"></span></a>
              </td>
              </tr>
              <?php endforeach ?>
            </tbody>
